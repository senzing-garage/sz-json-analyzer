...
'''
# -----------------------------------------------------------------------------
# sz-file-analyzer.py Example python skeleton.
...
def get_parser():
    ...
    parser = argparse.ArgumentParser(prog="sz-file-analyzer.py", description="Add description. For more information, see https://github.com/senzing-garage/sz-file-analyzer")
